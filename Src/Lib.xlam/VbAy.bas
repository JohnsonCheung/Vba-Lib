...
Dim O1$()
    ...
    For J = 0 To U
        ...
        End If
    Next
If ValIsEmp(O1) Then Exit Function
Dim O2$()
...
Dim I
For Each I In A
    If ValIsEmp(I) Then Exit Function
Next
...
Dim I
For Each I In A
    If Not ValIsEmp(I) Then Push O, I
Next
AyRmvEmp = O
End Function
...
If Not ValIsLngAy(IxAy) Then Exit Function
