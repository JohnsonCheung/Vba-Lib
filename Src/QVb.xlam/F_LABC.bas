...
'Set A = VdtDupFld(A)
'Dim O1 As FnyRslt
'Set LABCAy_ValidateAsFny = O.Init(UniqFny, A.ErLy, C1, C2)
End Property
...
Property Get LABCAy_LxFldAy(A() As LABC) As LxFld()
Stop '
...
Property Get LABCAy_ValidateAsFldVal(A() As LABC, Fny$()) As LABCAyRslt
Dim A1 As LABCAyRslt: Set A1 = VdtErFld(Fny)
Dim A2 As LABCAyRslt: Set A2 = VdtDupFld(A1)
Set LABCAy_ValidateAsFldVal = A2
End Property
...
Stop '
'Dim A() As LABC: A = LyLABCAy(SslSy("Lo IsVF"))
'Debug.Print A.ToStr
...
Property Get FldSslAy() As String()
Stop '
'If IsEmp Then Exit Property
'Dim I, M As LABC, O$()
'For Each I In A
