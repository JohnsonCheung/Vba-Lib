...
'ZIs_NmChr = False
'End Property
'Private Property Get ZLin_Nm$(L$)
'Dim J%
'If Not ZIs_Letter(Left(L, 1)) Then Exit Property
'For J = 2 To Len(L)
'    If Not ZIs_NmChr(Mid(L, J, 1)) Then
'        ZLin_Nm = Left(L, J - 1)
'        Exit Property
'    End If
'Next
...
'Dim Ny$(): Ny = ZCurPj_MbrNyLik(MdLikNm)
...
'Dim FmMd As CodeModule
'Dim FmMdNm$
'Dim FmPj As VBProject
'    Set FmMd = ZCurMd
'    Set FmPj = ZMd_Pj(FmMd)
'    FmMdNm = FmMd.Parent.Name
'If FmMdNm = "M_Tool" And ZCurPj = "QTool" Then
'    Debug.Print "Md(QTool.M_Tool) cannot be moved"
'    Exit Sub
'End If
'Dim ToPj As VBProject
'    Set ToPj = ZPj(ToPjNm)
'Dim MdNm$: MdNm = ZCurMdNm
'If ZPj_HasMdNm(ToPj, MdNm) Then
'    Debug.Print ZFmtQQ("Mov_Md: Md(?) exists in TarPj(?).  Skip moving", MdNm, ToPjNm)
'    Exit Sub
'End If
'If MdNm Like "A_*" Then
'    Debug.Print ZFmtQQ("MovMd: Md(?) has like A_*.  Skip moving", MdNm, ToPjNm)
'    Exit Sub
'End If
'Dim SrcCmp As VBComponent
'Dim ZTmpFil$
'    ZTmpFil = ZTmpFfn(".txt")
'    Set SrcCmp = ZCurPj_Cmp(MdNm)
'    SrcCmp.Export ZTmpFil
'    If SrcCmp.Type = vbext_ct_ClassModule Then
'        ZFt_RmvFst4Lines ZTmpFil
'    End If
'Dim TarCmp As VBComponent
'    Set TarCmp = ToPj.VBComponents.Add(FmMd.Parent.Type)
'    TarCmp.CodeModule.AddFromFile ZTmpFil
'ZCurPj.VBComponents.Remove SrcCmp
'Kill ZTmpFil
'Debug.Print ZFmtQQ("MovMd: Md(?) is moved from SrcPj(?) to TarPj(?).", MdNm, ZCurPjNm, ToPjNm)
'End Sub
'
...
'ZPj_Go ZPj(PjNm)
'End Sub
'Private Sub Brk2_Asg(A$, Sep$, O1$, O2$)
'Dim P%: P = InStr(A, Sep)
'If P = 0 Then
'    O1 = ""
'    O2 = Trim(A)
...
'    Md, MthNm
'ZMd_GoSomLCC Md, ZMdMth_SomLCC(Md, MthNm)
'End Sub
'
...
'
'Sub Go_Mbr(Nm$)
'If Not ZCurPj_HasCmp(Nm) Then
'    Debug.Print ZFmtQQ("Md(?) not found in CurPj(?)", Nm, ZCurPjNm)
'    Exit Sub
'End If
'ZMd_Go ZMd(Nm)
'End Sub
...
'ZMd_GoSomLCC Md, ZMdMth_SomLCC(Md, MthNm)
'End Sub
'Private Sub ZMd_GoSomLCC(Md As CodeModule, SomLCC As SomLCC)
'ZMd_Go Md
'With SomLCC
'    If .Som Then
'        With .LCC
...
'ZLin_RmvMdy = L
'End Property
'Private Property Get ZLinMth_SomLCC(L$, MthNm$, Lno%) As SomLCC
'Dim A$
'A = ZLin_RmvMdy(L)
'If ZHasPfx(A, "Sub ") Then
'    A = ZRmvPfx(A, "Sub ")
'ElseIf ZHasPfx(A, "Property Get ") Then
'    A = ZRmvPfx(A, "Property Get ")
'ElseIf ZHasPfx(A, "Property Get ") Then
'    A = ZRmvPfx(A, "Property Get ")
'ElseIf ZHasPfx(A, "Property Let ") Then
'    A = ZRmvPfx(A, "Property Let ")
'ElseIf ZHasPfx(A, "Property Set ") Then
'    A = ZRmvPfx(A, "Property Set ")
'Else
'    Exit Property
'End If
'A = ZLin_Nm(A)
'If A <> MthNm Then Exit Property
'Dim C1%, C2%
'C1 = InStr(L, MthNm)
'C2 = C1 + Len(MthNm)
'With ZLinMth_SomLCC
...
'End Property
'
'Private Property Get ZMdMth_SomLCC(Md As CodeModule, MthNm$) As SomLCC
'With Md
'    Dim L%, M As SomLCC
'    For L = .CountOfDeclarationLines + 1 To .CountOfLines
'        M = ZLinMth_SomLCC(.Lines(L, 1), MthNm, L)
'        If M.Som Then
'            ZMdMth_SomLCC = M
'            Exit Property
'        End If
...
'ZVbe_PjAy = O
'End Property
'Sub Brw_CurVbe_SrtRpt()
'ZAyBrw ZVbe_SrtRptLy(ZCurVbe)
'End Sub
'Sub Brw_CurPj_SrtRpt()
...
'End Property
'Private Function ZPj_MbrNy(A As VBProject, Optional MbrNmPatn$ = ".") As String()
'ZPj_MbrNy = ZOyNy(ZPj_MbrAy(A, MbrNmPatn))
'End Function
'
'Private Function ZPj_MbrAy(A As VBProject, Optional MbrNmPatn$ = ".") As CodeModule()
'Dim O() As CodeModule
'Dim Cmp As VBComponent
...
'End Property
'
'Private Property Get ZOyNy(Oy) As String()
'If ZSz(Oy) = 0 Then Exit Property
'Dim I, O$()
'For Each I In Oy
...
'ZLin_T1 = Left(A, P - 1)
'End Property
'Private Property Get ZIs_FunTy(Kw$) As Boolean
'Select Case Kw
'Case "Property", "Sub", "Function": ZIs_FunTy = True
'End Select
'End Property
'Private Property Get ZSrcLin_IsMth(SrcLin) As Boolean
'ZSrcLin_IsMth = ZIs_FunTy(ZLin_T1(ZSrcLin_RmvMdy(SrcLin)))
'End Property
'
...
'ZAyWhFmTo = O
'End Property
'Private Property Get ZSrc_MthKy(A$(), Optional IsSngLinFmt As Boolean) As String()
'Dim A1&(): A1 = ZSrc_MthLxAy(A)
'If ZSz(A1) = 0 Then Exit Property
'Dim O$()
'    Dim K$
...
'    Dim L$
'    For Each MthLx In A1
'        ZPush O, ZMthLin_MthKey(A(MthLx), IsSngLinFmt:=IsSngLinFmt)
'    Next
'ZSrc_MthKy = O
'End Property
...
'
''Dim I As VBProject
''For Each I In ZCurVbe.VBProjects
''    If I.Name = PjNm Then Set ZPj = I: Exit Property
''Next
''Debug.Print PjNm
''Stop
'End Property
...
'ZMd_MthKy = ZSrc_MthKy(ZMd_Src(A), IsSngLinFmt)
'End Property
'Sub Brw_MthKy()
