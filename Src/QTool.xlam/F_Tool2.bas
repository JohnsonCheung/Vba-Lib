...
'End Property
'
'Property Get ZAyAddSfx(Ay, Sfx) As String()
'If ZSz(Ay) = 0 Then Exit Property
'Dim O$(), I
'For Each I In Ay
'    ZPush O, I & Sfx
...
'End Property
'
'Property Get ZFFunNy_DupFFunNy(A$()) As String()
...
'End Property
'
'Property Get ZVbe_DupFFunNy(A As VBE, Optional IsNoSrt As Boolean) As String()
'Dim N$(): N = ZVbe_FFunNy(A, IsNoSrt:=True)
'ZVbe_DupFFunNy = ZFFunNy_DupFFunNy(N)
'End Property
'
'Property Get ZVbe_FFunNy(A As VBE, Optional IsNoSrt As Boolean) As String()
'Dim Ay() As VBProject
'    Ay = ZVbe_PjAy(A)
'If ZSz(Ay) = 0 Then Exit Property
'Dim O$(), I
...
'End Property
'
'Property Get ZAy_Map_Sy(A, MapFunNm$) As String()
...
'End Property
'
'Property Get ZAy_Map(A, MapFunNm$)
'ZAy_Map = ZAy_Map_Into(A, MapFunNm, ZEmpAy)
'End Property
'
'Property Get ZAy_Map_Into(A, MapFunNm$, OIntoAy)
'Erase OIntoAy
'Dim I
'If ZSz(A) > 0 Then
'    For Each I In A
...
'End Property
'
'Property Get ZSrc_MthNy(A$(), Optional MthNmPatn$ = ".", Optional IsNoSrt As Boolean) As String()
'Dim A1&(): A1 = ZSrc_MthLxAy(A)
'If ZSz(A1) = 0 Then Exit Property
'Dim O$()
