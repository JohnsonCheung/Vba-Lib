...
'AyBrw ZCurPj_MthNy(MthNmPatn:=MthNmPatn, MdNmPatn:=MdNmPatn)
'End Sub
'
'Sub Brw_Pj_MthKy()
...
'AyDmp AyAddPfx(ZCurMd_MthNy(MthNmPatn), ZCurMdNm & ".")
'End Sub
'
...
'
'End Property
'Property Get ZCurPubFunOpt() As MthOpt
...
'End Property
'
'Private Property Get AyFstNEle(Ay, N&)
'Dim O: O = Ay
'ReDim Preserve O(N - 1)
'AyFstNEle = O
'End Property
'
'Private Property Get AyHas(Ay, Itm) As Boolean
...
'End Property
'
'Private Property Get AyIns(Ay, Optional Ele, Optional At&)
'Const CSub$ = "AyIns"
'Dim N&: N = ZSz(Ay)
...
'End Property
'
'Private Property Get Ay_Map(A, MapFunNm$)
'Ay_Map = Ay_Map_Into(A, MapFunNm, ZEmpAy)
'End Property
'
'Private Property Get Ay_Map_Into(A, MapFunNm$, OIntoAy)
'Erase OIntoAy
'Dim I
'If ZSz(A) > 0 Then
'    For Each I In A
...
'End Property
'
'Private Property Get Ay_Map_Sy(A, MapFunNm$) As String()
'Ay_Map_Sy = Ay_Map_Into(A, MapFunNm, ZEmpSy)
'End Property
'
...
'End Property
'Private Property Get AyIsAllEq(A) As Boolean
'If ZSz(A) = 0 Then AyIsAllEq = True: Exit Property
'Dim J&
'For J = 1 To ZUB(A)
...
'ZDupFFunNyGp_IsDup = AyIsAllEq(Ay_Map(Ny, "ZFFun_MthLines"))
'End Property
